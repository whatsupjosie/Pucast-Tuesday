...
INPUT_GLB = os.path.join(SCRIPT_DIR, "sir_purfluous_v3_bound_actor.glb")
OUTPUT_JSON = os.path.join(SCRIPT_DIR, "sir_purfluous_v3_bound_actor_inspection.json")
...
for obj in bpy.context.scene.objects:
    ...
    if obj.type == "MESH":
        ...
        entry["modifiers"] = [modifier.type for modifier in obj.modifiers]
        entry["vertex_groups"] = [group.name for group in obj.vertex_groups]
